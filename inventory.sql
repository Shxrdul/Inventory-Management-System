--------------------------------------------------------
--  File created - Thursday-January-02-2020   
--------------------------------------------------------
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table ASSET_ALLOC
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."ASSET_ALLOC" 
   (	"POID" VARCHAR2(20 BYTE), 
	"POSER" VARCHAR2(20 BYTE), 
	"LOCID" VARCHAR2(20 BYTE), 
	"ASSETID" VARCHAR2(20 BYTE), 
	"QUANTITY" VARCHAR2(20 BYTE), 
	"SERIALID" VARCHAR2(20 BYTE)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table ASSET_DISCARD
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."ASSET_DISCARD" 
   (	"POID" VARCHAR2(20 BYTE), 
	"POSER" VARCHAR2(20 BYTE), 
	"ASSETID" VARCHAR2(20 BYTE), 
	"QUANTITY" VARCHAR2(20 BYTE), 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."LOCATION" 
   (	"LOCID" VARCHAR2(20 BYTE), 
	"FLOORNO" VARCHAR2(20 BYTE), 
	"LOCNAME" VARCHAR2(20 BYTE), 
	"ROOMTYPE" VARCHAR2(20 BYTE)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table MASTER_ASSET
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."MASTER_ASSET" 
   (	"ID" NUMBER(*,0), 
	"NAME" VARCHAR2(20 BYTE), 
	"ELECTRONIC" VARCHAR2(20 BYTE), 
	"SERIALMAINT" VARCHAR2(20 BYTE)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
--------------------------------------------------------
--  DDL for Table POASSET
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."POASSET" 
   (	"POID" VARCHAR2(20 BYTE), 
	"POSER" VARCHAR2(20 BYTE), 
	"ASSETID" VARCHAR2(20 BYTE), 
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table USERREG
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."USERREG" 
   (	"NAME" VARCHAR2(40 BYTE), 
	"PASS" VARCHAR2(40 BYTE), 
	"ROLEID" VARCHAR2(20 BYTE) DEFAULT 3
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.ASSET_ALLOC
SET DEFINE OFF;
Insert into SYSTEM.ASSET_ALLOC (POID,POSER,LOCID,ASSETID,QUANTITY,SERIALID) values ('101','9324038899','110','60','5','N/A');
Insert into SYSTEM.ASSET_ALLOC (POID,POSER,LOCID,ASSETID,QUANTITY,SERIALID) values ('100','7303738899','110','58','1','74');
Insert into SYSTEM.ASSET_ALLOC (POID,POSER,LOCID,ASSETID,QUANTITY,SERIALID) values ('101','9324038899','81','60','3','N/A');
Insert into SYSTEM.ASSET_ALLOC (POID,POSER,LOCID,ASSETID,QUANTITY,SERIALID) values ('100','7303738899','110','58','1','76');
Insert into SYSTEM.ASSET_ALLOC (POID,POSER,LOCID,ASSETID,QUANTITY,SERIALID) values ('100','7303738899','110','58','1','77');
Insert into SYSTEM.ASSET_ALLOC (POID,POSER,LOCID,ASSETID,QUANTITY,SERIALID) values ('100','7303738899','81','58','1','73');
REM INSERTING into SYSTEM.ASSET_DISCARD
SET DEFINE OFF;
Insert into SYSTEM.ASSET_DISCARD (POID,POSER,ASSETID,QUANTITY,SERIALID) values ('100','7303738899','58','1','75');
Insert into SYSTEM.ASSET_DISCARD (POID,POSER,ASSETID,QUANTITY,SERIALID) values ('101','9324038899','60','2','N/A');
...
SET DEFINE OFF;
Insert into SYSTEM.LOCATION (LOCID,FLOORNO,LOCNAME,ROOMTYPE) values ('81','GRND','R001','Yes');
Insert into SYSTEM.LOCATION (LOCID,FLOORNO,LOCNAME,ROOMTYPE) values ('82','GRND','R002','Yes');
Insert into SYSTEM.LOCATION (LOCID,FLOORNO,LOCNAME,ROOMTYPE) values ('83','GRND','R003','Yes');
Insert into SYSTEM.LOCATION (LOCID,FLOORNO,LOCNAME,ROOMTYPE) values ('84','GRND','R004','Yes');
Insert into SYSTEM.LOCATION (LOCID,FLOORNO,LOCNAME,ROOMTYPE) values ('85','1','R101','Yes');
Insert into SYSTEM.LOCATION (LOCID,FLOORNO,LOCNAME,ROOMTYPE) values ('86','1','R102','Yes');
Insert into SYSTEM.LOCATION (LOCID,FLOORNO,LOCNAME,ROOMTYPE) values ('87','1','R103','Yes');
Insert into SYSTEM.LOCATION (LOCID,FLOORNO,LOCNAME,ROOMTYPE) values ('88','1','R104','Yes');
Insert into SYSTEM.LOCATION (LOCID,FLOORNO,LOCNAME,ROOMTYPE) values ('89','2','R201','Yes');
Insert into SYSTEM.LOCATION (LOCID,FLOORNO,LOCNAME,ROOMTYPE) values ('90','2','R202','Yes');
Insert into SYSTEM.LOCATION (LOCID,FLOORNO,LOCNAME,ROOMTYPE) values ('91','2','R203','Yes');
Insert into SYSTEM.LOCATION (LOCID,FLOORNO,LOCNAME,ROOMTYPE) values ('92','2','R204','Yes');
Insert into SYSTEM.LOCATION (LOCID,FLOORNO,LOCNAME,ROOMTYPE) values ('93','3','H31','No');
Insert into SYSTEM.LOCATION (LOCID,FLOORNO,LOCNAME,ROOMTYPE) values ('94','3','H32','No');
Insert into SYSTEM.LOCATION (LOCID,FLOORNO,LOCNAME,ROOMTYPE) values ('95','4','H41','No');
Insert into SYSTEM.LOCATION (LOCID,FLOORNO,LOCNAME,ROOMTYPE) values ('96','4','H42','No');
Insert into SYSTEM.LOCATION (LOCID,FLOORNO,LOCNAME,ROOMTYPE) values ('97','4','H43','No');
Insert into SYSTEM.LOCATION (LOCID,FLOORNO,LOCNAME,ROOMTYPE) values ('98','5','R501','Yes');
Insert into SYSTEM.LOCATION (LOCID,FLOORNO,LOCNAME,ROOMTYPE) values ('99','5','R502','Yes');
Insert into SYSTEM.LOCATION (LOCID,FLOORNO,LOCNAME,ROOMTYPE) values ('100','5','R503','Yes');
Insert into SYSTEM.LOCATION (LOCID,FLOORNO,LOCNAME,ROOMTYPE) values ('101','5','R504','Yes');
Insert into SYSTEM.LOCATION (LOCID,FLOORNO,LOCNAME,ROOMTYPE) values ('102','6','R601','Yes');
Insert into SYSTEM.LOCATION (LOCID,FLOORNO,LOCNAME,ROOMTYPE) values ('103','6','R602','Yes');
Insert into SYSTEM.LOCATION (LOCID,FLOORNO,LOCNAME,ROOMTYPE) values ('104','6','R603','Yes');
Insert into SYSTEM.LOCATION (LOCID,FLOORNO,LOCNAME,ROOMTYPE) values ('105','6','R604','Yes');
Insert into SYSTEM.LOCATION (LOCID,FLOORNO,LOCNAME,ROOMTYPE) values ('106','7','R701','Yes');
Insert into SYSTEM.LOCATION (LOCID,FLOORNO,LOCNAME,ROOMTYPE) values ('107','7','R702','Yes');
Insert into SYSTEM.LOCATION (LOCID,FLOORNO,LOCNAME,ROOMTYPE) values ('108','7','R703','Yes');
Insert into SYSTEM.LOCATION (LOCID,FLOORNO,LOCNAME,ROOMTYPE) values ('109','7','R704','Yes');
Insert into SYSTEM.LOCATION (LOCID,FLOORNO,LOCNAME,ROOMTYPE) values ('110','2','Storage','No');
Insert into SYSTEM.LOCATION (LOCID,FLOORNO,LOCNAME,ROOMTYPE) values ('111','3','Canteen','No');
Insert into SYSTEM.LOCATION (LOCID,FLOORNO,LOCNAME,ROOMTYPE) values ('112','1','Office','No');
...
SET DEFINE OFF;
Insert into SYSTEM.MASTER (ATTRIBUTE,VALUE) values ('floors',7);
Insert into SYSTEM.MASTER (ATTRIBUTE,VALUE) values ('runlocid',113);
Insert into SYSTEM.MASTER (ATTRIBUTE,VALUE) values ('runassetid',61);
Insert into SYSTEM.MASTER (ATTRIBUTE,VALUE) values ('runpoid',102);
Insert into SYSTEM.MASTER (ATTRIBUTE,VALUE) values ('runserialid',78);
Insert into SYSTEM.MASTER (ATTRIBUTE,VALUE) values ('runvendorid',35);
REM INSERTING into SYSTEM.MASTER_ASSET
SET DEFINE OFF;
Insert into SYSTEM.MASTER_ASSET (ID,NAME,ELECTRONIC,SERIALMAINT) values (58,'TV','yes','yes');
Insert into SYSTEM.MASTER_ASSET (ID,NAME,ELECTRONIC,SERIALMAINT) values (59,'Chair','no','yes');
Insert into SYSTEM.MASTER_ASSET (ID,NAME,ELECTRONIC,SERIALMAINT) values (60,'Towel','no','no');
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.POASSET
SET DEFINE OFF;
Insert into SYSTEM.POASSET (POID,POSER,ASSETID,MAKE,MODEL,QUANTITY,VENDOR,CATEGORY,WARSTATUS,STARTDATE,ENDDATE,SERIALNO,DISCARDED) values ('100','7303738899','58','Sony','Bravia','1','REGANTA','capital','In Warranty','2020-01-01','2022-01-01','73',0);
Insert into SYSTEM.POASSET (POID,POSER,ASSETID,MAKE,MODEL,QUANTITY,VENDOR,CATEGORY,WARSTATUS,STARTDATE,ENDDATE,SERIALNO,DISCARDED) values ('100','7303738899','58','Sony','Bravia','1','REGANTA','capital','In Warranty','2020-01-01','2022-01-01','74',0);
Insert into SYSTEM.POASSET (POID,POSER,ASSETID,MAKE,MODEL,QUANTITY,VENDOR,CATEGORY,WARSTATUS,STARTDATE,ENDDATE,SERIALNO,DISCARDED) values ('100','7303738899','58','Sony','Bravia','1','REGANTA','capital','In Warranty','2020-01-01','2022-01-01','75',1);
Insert into SYSTEM.POASSET (POID,POSER,ASSETID,MAKE,MODEL,QUANTITY,VENDOR,CATEGORY,WARSTATUS,STARTDATE,ENDDATE,SERIALNO,DISCARDED) values ('100','7303738899','58','Sony','Bravia','1','REGANTA','capital','In Warranty','2020-01-01','2022-01-01','76',0);
Insert into SYSTEM.POASSET (POID,POSER,ASSETID,MAKE,MODEL,QUANTITY,VENDOR,CATEGORY,WARSTATUS,STARTDATE,ENDDATE,SERIALNO,DISCARDED) values ('100','7303738899','58','Sony','Bravia','1','REGANTA','capital','In Warranty','2020-01-01','2022-01-01','77',0);
Insert into SYSTEM.POASSET (POID,POSER,ASSETID,MAKE,MODEL,QUANTITY,VENDOR,CATEGORY,WARSTATUS,STARTDATE,ENDDATE,SERIALNO,DISCARDED) values ('101','9324038899','60','JK','Blue XL','10','ATRIUM','N/A','N/A',null,null,'N/A',2);
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.USERREG
SET DEFINE OFF;
Insert into SYSTEM.USERREG (NAME,PASS,ROLEID) values ('shardul','1234','1
');
Insert into SYSTEM.USERREG (NAME,PASS,ROLEID) values ('yogesh','1234','2');
Insert into SYSTEM.USERREG (NAME,PASS,ROLEID) values ('user','user','3');
REM INSERTING into SYSTEM.VENDOR
SET DEFINE OFF;
Insert into SYSTEM.VENDOR (ID,NAME,ADDRESS,CONTACT,EMAIL) values ('32','MXAUTO
','kalyan','2558369','xyz@xyz.com');
Insert into SYSTEM.VENDOR (ID,NAME,ADDRESS,CONTACT,EMAIL) values ('33','ATRIUM','nerul','4869374','lmn@pqr.com');
Insert into SYSTEM.VENDOR (ID,NAME,ADDRESS,CONTACT,EMAIL) values ('34','REGANTA','thane','7582691','abc@ghi.com');
--------------------------------------------------------
...
--------------------------------------------------------
--  Constraints for Table MASTER_ASSET
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."MASTER_ASSET" MODIFY ("ELECTRONIC" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."MASTER_ASSET" MODIFY ("ID" NOT NULL ENABLE);
--------------------------------------------------------
