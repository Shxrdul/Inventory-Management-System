...
<html>
        ...
        <div class="container"> 
            <div class="d-flex justify-content-center py-5"> 
                <div class="col-sm-6 col-lg-3 text-center my-3">
                    <h1 class="font-weight-bolder align-self-center mx-1">USER</h1>	
                </div>		
            </div>
        </div>
    </header>
    <div class="container height-max" >
        <div class="row p-4">
            <a class=" col-12 col-md-4 p-4" href="viewBuilding.jsp">
            ...
            <a class=" col-12 col-md-4 p-4" href="viewAsset.jsp">
                <div class="check-card justify-content-center text-center p-2">
                    <div class="check-icon p-2 rounded-circle">
                        <i class="far fa-flag"></i>
                    </div>
            ...
            <a class=" col-12 col-md-4 p-4" href="allocation.jsp">
                <div class="check-card justify-content-center text-center p-2">
                    <div class="check-icon p-2 rounded-circle">
                        <i class="far fa-flag"></i>
                    </div>
